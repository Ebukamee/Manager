  ...
  >
    ...
    >
      <div class="flex items-center justify-between mb-8">
        ...
        <button
          @click="toggleTheme"
          class="p-2 rounded-full text-slate-400 hover:bg-slate-50 dark:hover:bg-neutral-900"
        >
      ...
      <nav class="flex-1 space-y-1">
        ...
        >
          <div
            ...
            class="absolute left-0 h-5 w-1 bg-sky-600 rounded-r-full"
          ></div>
    ...
    <div
      class="fixed bottom-6 left-0 right-0 flex justify-center lg:hidden z-50 pointer-events-none"
    >
      <div
        class="pointer-events-auto w-[80%] justify-between flex items-center bg-white/90 backdrop-blur border p-1.5 border-white rounded-xl shadow-xl dark:bg-neutral-900 dark:border-neutral-900"
      >
        <NuxtLink
          v-for="item in navItems"
          :key="item.name"
