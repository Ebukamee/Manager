...
const requestPasswordReset = async () => {
    ...
    if (error) {
        ...
        successMessage.value = 'Reset instructions have been sent to your email.'
    }
}
</script>
        ...
        <div
            ...
            <form class="mt-6 space-y-4" @submit.prevent="requestPasswordReset">
                ...
                <button :disabled="loading"
                    class="w-full rounded-xl bg-gradient-to-r from-sky-600 to-cyan-500 py-3 text-sm font-bold text-white shadow-lg shadow-sky-500/20 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50">
