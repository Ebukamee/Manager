...
const handleSignUp = async () => {
  ...
  if (error) {
    ...
    try {
      ...
      errorMessage.value =
        "Account created, but we couldn't send the email. Please try resending from the login page.";
    } finally {
      loading.value = false;
    }
  }
  ...
  <div class="group relative">
    ...
    >
      <div class="flex flex-col items-center text-center">
        ...
        >
          <svg
            class="h-5 w-5 text-sky-600 dark:text-cyan-400"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="2"
      ...
      <div class="mt-6">
        ...
        <button
          @click="handleGoogleSignInWrapper"
