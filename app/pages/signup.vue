  ...
  <div class="group relative">
    ...
    <div class="relative overflow-hidden rounded-[2rem] bg-white/90 px-6 py-8 shadow-2xl backdrop-blur-xl ring-1 ring-gray-100 dark:bg-black/80 dark:ring-neutral-800 sm:px-8">
      ...
      <div class="mt-6">
        ...
        <button class="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white py-2.5 hover:bg-gray-50 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-900 dark:hover:bg-neutral-800 transition" @click="handleGoogleSignInWrapper">
            ...
            <span class="text-xs font-semibold text-gray-700 dark:text-gray-300">{{ googleLoading ? 'Signing up...' : 'Sign up with Google' }}</span>
        </button>
      </div>
